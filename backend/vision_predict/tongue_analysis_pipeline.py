...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("使用方法: python -m vision_predict.tongue_analysis_pipeline <圖像路徑> [輸出格式] [輸出目錄]")
        print("\n範例:")
        print("  python -m vision_predict.tongue_analysis_pipeline selfie.jpg")
        print("  python -m vision_predict.tongue_analysis_pipeline selfie.jpg json")
        print("  python -m vision_predict.tongue_analysis_pipeline selfie.jpg structured results")
    else:
